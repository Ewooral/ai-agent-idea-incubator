        ...
        <CardContent className="space-y-8">
          {savedIdeas.length > 0 ? (
            <div className="space-y-4">
              <h2 className="font-headline text-xl sm:text-2xl">Your Saved Ideas</h2>
              {savedIdeas.map((idea) => (
            ...
            <div className="text-center py-10 border rounded-lg bg-muted/20">
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 text-foreground">No Saved Ideas Yet</h3>
